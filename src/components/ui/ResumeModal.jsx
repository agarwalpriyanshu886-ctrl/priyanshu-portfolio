                  ...
                  {isAvailable && res.url ? (
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      <button
                        type="button"
                        disabled
                        className="inline-flex items-center gap-2 text-xs font-semibold text-amber-300 bg-amber-500/10 border border-amber-500/30 rounded-xl px-4 py-2 opacity-90 cursor-not-allowed shadow-sm"
                      >
                        <FaClock className="text-amber-400 animate-pulse text-xs" /> Under Progress — Will be available soon.
                      </button>
                    </div>
                  )}
                </div>
